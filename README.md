...
*  Type ```git clone https://github.com/psu-ds410/hws-spring2026-[github-username].git ds410hw```
...
**Important:** you can also access your repository on the web: `https://github.com/psu-ds410/hws-spring2026-[your-github-username]` (🤦 alert)
